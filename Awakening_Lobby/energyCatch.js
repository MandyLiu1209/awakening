...
function getRequiredEnergyForDay(day) {
    const thresholds = {
        1: 10,  //2, //10,  // 第 1 天需要 10 分才能玩
        2: 10,  //2, //10,  // 第 2 天需要 10 分
        3: 10,  //2, //10,  // 第 3 天需要 10 分
        4: 10,  //2, //10,  // 第 4 天需要 10 分
        5: 13,  //4, //13,  // 第 5 天需要 13 分
        6: 13,  //4, //13,  // 第 6 天需要 13 分
        7: 13,  //4, //13, //13,  // 第 7 天需要 13 分
        8: 13,  //4, //13,  // 第 8 天需要 13 分
        9: 13,  //4, //13,  // 第 9 天需要 13 分
        10: 13,  //4, //13, // 第 10 天需要 13 分
        11: 16,  //6, //16, // 第 11 天需要 16 分
        12: 16,  //6, //16, // 第 12 天需要 16 分
        13: 16,  //6, //16, // 第 13 天需要 16 分
        14: 55,  //15, //55  // 第 14 天需要 55 分 (最後一天打卡給10分)
    };
