...
console.log("🚀 這是最新的龍舟引擎 v20260629");
alert("🚀 這是最新的龍舟引擎 v20260629_2"); // 這行會跳出彈窗，告訴你現在跑的是哪版
...
function getRequiredEnergyForDay(day) {
    const thresholds = {
        1: 10,  //2, //13,  // 第 1 天需要 13 分才能玩
        2: 10,  //2, //13,  // 第 2 天需要 13 分
        3: 10,  //2, //13,  // 例如第 3 天任務比較難，可以提高到 18 分
        4: 10,  //2, //13,
        5: 10,  //4, //16,  
        6: 13,  //4, //16,  // 
        7: 13,  //4, //16,  // 
